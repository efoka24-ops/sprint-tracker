...
export const AVEC_PORTEURS = {
  ...
  sprint: { select: { id: true, libelle: true, numero: true, cloture: true } },
...
export const presenter = (projet) => ({
  ...projet,
  suiviChecklist: projet.suiviChecklist !== false,
...
export function valider(b) {
  ...
  if (b.suiviChecklist !== undefined && typeof b.suiviChecklist !== 'boolean') {
    return 'Le suivi checklist doit être un booléen';
  }
  return null;
}
